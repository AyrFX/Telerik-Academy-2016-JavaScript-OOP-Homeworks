...
describe('Academy Catalogs', function () {
    describe('Book tests', function () {
        describe('Valid tests', function () {
            // test 1
            it(
                'expect getBook to exist, to be a function and to return object with properties unique id, name, description, isbn and genre',
                function () {
                    var name,
                        isbn,
                        genre,
        ...
        describe('Invalid tests', function () {
            ...
            it('Expect invalid name to throw', function () {
                ...
                function testName_undefined() {
                    result.getBook(undefined, utils.valid.getISBN10(), utils.valid.getGenre(),
                        utils.valid.getDescription());
                }

                function testNameSetter_undefined() {
                    var book = result.getBook(utils.valid.getName(), utils.valid.getISBN10(),
                        utils.valid.getGenre(), utils.valid.getDescription());
                    book.name = undefined;
                }

                function testName_null() {
                    result.getBook(null, utils.valid.getISBN10(), utils.valid.getGenre(),
                        utils.valid.getDescription());
                }
                ...
                function testName_EmptyString() {
                    result.getBook('', utils.valid.getISBN10(), utils.valid.getGenre(),
                        utils.valid.getDescription());
                }
                ...
                function testName_Short() {
                    result.getBook(utils.invalid.getShorterName(), utils.valid.getISBN10(),
                        utils.valid.getGenre(), utils.valid.getDescription());
                }
            ...
            it('Expect invalid isbn to throw', function () {
                function testISBN_undefined() {
                    result.getBook(utils.valid.getName(), undefined, utils.valid.getGenre(),
                        utils.valid.getDescription());
                }
                ...
                function testISBN_null() {
                    result.getBook(utils.valid.getName(), null, utils.valid.getGenre(),
                        utils.valid.getDescription());
                }
                ...
                function testISBN_EmptyString() {
                    result.getBook(utils.valid.getName(), '', utils.valid.getGenre(),
                        utils.valid.getDescription());
                }
                ...
                function testISBN_10WithLetters() {
                    result.getBook(utils.valid.getName, utils.invalid.getInvalidISBN10WithLetters(),
                        utils.valid.getGenre(), utils.valid.getDescription());
                }
                ...
                function testISBN_13WithLetters() {
                    result.getBook(utils.valid.getName, utils.invalid.getInvalidISBN13WithLetters(),
                        utils.valid.getGenre(), utils.valid.getDescription());
                }

                function testISBNSetter_13WithLetters() {
                    var book = result.getBook(utils.valid.getName(), utils.valid.getISBN13(),
                        utils.valid.getGenre(), utils.valid.getDescription());
                    book.isbn = utils.invalid.getInvalidISBN13WithLetters();
                }

                function testISBN_not10or13() {
                    result.getBook(utils.valid.getName, utils.invalid.getInvalidISBNNot10or13(),
                        utils.valid.getGenre(), utils.valid.getDescription());
                }
            ...
            it('Expect invalid genre to throw', function () {
                function testGenre_undefined() {
                    result.getBook(utils.valid.getName(), utils.valid.getISBN10(),
                        undefined, utils.valid.getDescription());
                }
                ...
                function testGenre_null() {
                    result.getBook(utils.valid.getName(), utils.valid.getISBN10(), null,
                        utils.valid.getDescription());
                }
                ...
                function testGenre_Short() {
                    result.getBook(utils.valid.getName(), utils.valid.getISBN10(),
                        utils.invalid.getShorterGenre(), utils.valid.getDescription()
                    );
                }
            ...
            it('Expect invalid description to throw', function () {
                ...
                function testDescription_undefined() {
                    result.getBook(utils.valid.getName(), utils.valid.getISBN10(),
                        utils.valid.getGenre(), undefined);
                }
    ...
    describe('Media tests', function () {
        describe('Valid tests', function () {
            // test 6
            it(
                'expect getMedia to exist, to be a function and to return object with properties unique id, name, description, duration and rating',
                function () {
                    var name,
                        duration,
                        rating,
    ...
    describe('BookCatalog tests', function () {
        describe('Valid tests', function () {
            ...
            it(
                'expect getBookCatalog to exist, to be a function and to return object with properties name and unique id and methods: add(), find() with 1 param and search() with 1 param',
                function () {
                    var name = utils.valid.getName(),
            ...
            // test 12
            it(
                'expect bookCatalog.add() to add books only and to work with array or books separated with comma',
                function () {
                    var catalog,
                        name,
                        description,
            ...
            // test 14
            it(
                'expect bookCatalog.find() by id to find the leftmost book in the items array or return null',
                function () {
                    var catalog,
                        book,
                        i,
            ...
            // test 15
            it(
                'expect bookCatalog.find() by options to find an array of book in the items array or return null',
                function () {
                    var catalog,
                        book,
                        findResult,
                    ...
                    expect(Array.isArray(catalog.find({
                        name: 'nonexistent'
                    }))).to.be.true;
                    expect(catalog.find({
                        name: 'nonexistent'
                    }).length).to.exits; // it is an array-like object
                    expect(catalog.find({
                        name: 'nonexistent'
                    }).length).to.equal(0);
            ...
            // test 16
            it('expect bookCatalog.search() to return an array of found items or empty array',
                function () {
                    var i,
                        catalog,
                        book,
            ...
            // test 17
            it(
                'Expect bookCatalog.search() to return empty array, when no books in catalog and when no books that contain the pattern ',
                function () {
                    var catalog,
                        i,
                        pattern,
                    ...
                    catalog.items = [];
                    for (i = 0; i < len; i += 1) {
                        catalog.items.push(result.getBook(namePrefix + i, isbn, genre,
                            description));
                    }
        ...
        describe('Invalid tests', function () {
            ...
            it(
                'Expect bookCatalog.search() to throw if pattern is undefined, null or empty string ',
                function () {
    ...
    describe('MediaCatalog tests', function () {
        describe('Valid tests', function () {
            ...
            it(
                'expect getMediaCatalog to exist, to be a function and to return object with properties name and unique id and methods: add(), find() with 1 param and search() with 1 param',
                function () {
                    var name = utils.valid.getName(),
            ...
            // test 22
            it(
                'expect mediaCatalog.add() to add media only and to work with array or media separated with comma',
                function () {
                    var catalog,
                        name,
                        description,
            ...
            // test 24
            it(
                'expect mediaCatalog.find() by id to find the leftmost media in the items array or return null',
                function () {
                    var catalog,
                        media,
                        book,
            ...
            // test 25
            it(
                'expect mediaCatalog.find() by options to find an array of media in the items array or return null',
                function () {
                    var catalog,
                        media,
                        findResult,
            ...
            // test 26
            it('expect mediaCatalog.search() to return an array of found items or empty array',
                function () {
                    var i,
                        catalog,
                        media,
            ...
            // test 27
            it(
                'Expect mediaCatalog.search() to return empty array, when no media in catalog and when no media that contain the pattern ',
                function () {
                    var catalog,
                        i,
                        pattern,
                    ...
                    catalog.items = [];
                    for (i = 0; i < len; i += 1) {
                        catalog.items.push(result.getMedia(namePrefix + i, rating, duration,
                            description));
                    }
                    pattern = namePrefix.substr(0, namePrefix.length - 1);
                    pattern += 'Something that surely cannot be found in the valid genre';
        ...
        describe('Invalid tests', function () {
            ...
            it(
                'Expect mediaCatalog.search() to throw if pattern is undefined, null or empty string ',
                function () {
